...
def analyze_java_with_jar(repo_path: str) -> List[Finding]:
    findings = []
    jar_path = os.path.abspath(os.path.join(os.path.dirname(__file__), "../../../apps/java-analyzer/target/java-analyzer-1.0-SNAPSHOT-jar-with-dependencies.jar"))
